...
export default function AdmissionPage() {
  ...
  const masterRequirements = [
    ...
    },
    {
      ...
      description:
        "صورة من المؤهل العلمي، صورة من الهوية الوطنية أو جواز السفر، صور شخصية حديثة.",
      icon: FileText,
    },
    {
      title: "الرسوم الدراسية",
      description:
        "سداد الرسوم المقررة وفق نظام الأكاديمية، مع إمكانية التقسيط حسب اللوائح المعتمدة.",
      icon: CreditCard,
    },
    {
      title: "المدة الزمنية",
      description:
        "تعتمد الأكاديمية نظام الساعات المعتمدة، وتتراوح بين 220 ساعة إلى 320 ساعة تدريبية.",
      icon: Clock,
    },
    {
          ...
          <div className="text-center text-white">
            ...
            <div className="mb-16">
              ...
              <p className="text-xl md:text-2xl text-academy-gold-200 max-w-5xl mx-auto leading-relaxed font-light font-arabic">
                انضم إلى آلاف الطلاب الذين حققوا أحلامهم الأكاديمية والمهنية
                معنا في بيئة تعليمية متميزة
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 max-w-6xl mx-auto">
              ...
              <div className="bg-gradient-to-br from-white/20 to-white/10 backdrop-blur-2xl p-10 rounded-[2rem] border border-white/25 text-center group hover:scale-105 hover:bg-gradient-to-br hover:from-white/25 hover:to-white/15 transition-all duration-700 shadow-[0_20px_40px_rgba(0,0,0,0.15)] hover:shadow-[0_32px_64px_rgba(0,0,0,0.25)]">
                ...
                <h3 className="text-white font-bold text-2xl mb-4 font-arabic tracking-wide">
                  قبول سريع
                </h3>
                <p className="text-emerald-300 text-lg leading-relaxed font-arabic">
                  معالجة طلبك خلال 4-7 أيام عمل
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-white/20 to-white/10 backdrop-blur-2xl p-10 rounded-[2rem] border border-white/25 text-center group hover:scale-105 hover:bg-gradient-to-br hover:from-white/25 hover:to-white/15 transition-all duration-700 shadow-[0_20px_40px_rgba(0,0,0,0.15)] hover:shadow-[0_32px_64px_rgba(0,0,0,0.25)]">
                <div className="w-20 h-20 bg-gradient-to-br from-academy-gold/30 to-academy-gold/20 rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-xl group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 border border-academy-gold/20">
                  <Shield
                    size={40}
                    className="text-academy-gold-light drop-shadow-lg"
                  />
                </div>
                <h3 className="text-white font-bold text-2xl mb-4 font-arabic tracking-wide">
                  شهادات معتمدة
                </h3>
                <p className="text-academy-gold-light text-lg leading-relaxed font-arabic">
                  شهادات معترف بها دولياً ومحلياً
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-white/20 to-white/10 backdrop-blur-2xl p-10 rounded-[2rem] border border-white/25 text-center group hover:scale-105 hover:bg-gradient-to-br hover:from-white/25 hover:to-white/15 transition-all duration-700 shadow-[0_20px_40px_rgba(0,0,0,0.15)] hover:shadow-[0_32px_64px_rgba(0,0,0,0.25)]">
                ...
                <p className="text-blue-300 text-lg leading-relaxed font-arabic">
                  مرافقة أكاديمية متكاملة ومتخصصة
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mb-24">
            ...
            <div className="mb-12">
              ...
              <p className="text-2xl md:text-3xl text-academy-dark-gray max-w-5xl mx-auto leading-relaxed font-semibold mb-8 font-arabic tracking-wide">
                اتبع هذه الخطوات البسيطة والمدروسة للتقديم والانضمام إلى برامجنا
                التعليمية المتميزة
              </p>
                ...
                >
                  ...
                  <div className="absolute top-6 right-6">
                    <div className="w-14 h-14 bg-gradient-to-br from-academy-gold via-academy-gold-light to-academy-gold-dark rounded-2xl flex items-center justify-center shadow-xl border border-academy-gold/20 hover:scale-110 transition-transform duration-500">
                      <span className="text-academy-blue font-bold text-lg font-arabic">
                        {step.step}
                      </span>
                    </div>
                  </div>
                  ...
                  <CardContent className="p-10 text-center relative z-10">
                    ...
                    <div className="mb-10">
                      <div className="w-24 h-24 bg-gradient-to-br from-academy-blue/15 to-academy-gold/15 rounded-3xl flex items-center justify-center mx-auto shadow-xl group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 border border-academy-blue/20 backdrop-blur-sm">
                        <Icon
                          className="text-academy-blue group-hover:text-academy-gold transition-colors duration-500"
                          size={40}
                        />
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                      <div className="flex-1 h-3 bg-slate-100 rounded-full overflow-hidden shadow-inner">
                        <div
                          className="h-full bg-gradient-to-r from-academy-blue via-academy-gold to-academy-blue rounded-full transition-all duration-1000 group-hover:w-full shadow-sm"
                          style={{ width: `${25 * step.step}%` }}
                        ></div>
                      </div>
                      <span className="text-academy-gold font-bold text-base font-arabic">
                        الخطوة {step.step}
                      </span>
                    </div>
                  </CardContent>
            ...
            <div className="bg-white/95 backdrop-blur-2xl rounded-[2rem] p-12 shadow-[0_32px_64px_rgba(0,0,0,0.15)] border border-slate-200/60 max-w-4xl mx-auto hover:shadow-[0_40px_80px_rgba(0,0,0,0.2)] transition-all duration-700">
              <div className="flex flex-col md:flex-row items-center justify-center gap-6 mb-8">
                ...
                <div className="text-center md:text-right">
                  <h3 className="text-academy-blue font-bold text-3xl mb-2 font-arabic tracking-wide">
                    عملية التقديم السريعة والموثوقة
                  </h3>
              ...
              <p className="text-academy-dark-gray leading-relaxed font-semibold text-xl font-arabic tracking-wide">
                نلتزم بمعالجة جميع طلبات التقديم خلال 4-7 أيام عمل كحد أقصى، مع
                إشعارك فوراً بحالة طلبك وتقديم الدعم اللازم في كل مرحلة
              </p>
        ...
        <div className="container mx-auto px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-24">
            ...
            <div className="mb-12">
              ...
              <p className="text-2xl md:text-3xl text-academy-dark-gray max-w-5xl mx-auto leading-relaxed font-semibold mb-8 font-arabic tracking-wide">
                تعرف على الشروط والمتطلبات اللازمة للالتحاق ببرامجنا التعليمية
                المتميزة والمعتمدة دولياً
              </p>
              <p className="text-xl text-academy-darker-gray max-w-4xl mx-auto leading-relaxed font-arabic">
                نحن نلتزم بمعايير أكاديمية عالية لضمان جودة التعليم وتميز
                الخريجين
              </p>
            </div>
          </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1">
                          <h4 className="font-bold text-academy-blue group-hover:text-academy-gold mb-4 text-xl font-arabic tracking-wide transition-colors duration-300">
                            {req.title}
                          </h4>
                          <p className="text-academy-dark-gray leading-relaxed font-semibold text-lg font-arabic">
                            {req.description}
                  ...
                  {doctoralRequirements.map((req, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1">
                          <h4 className="font-bold text-academy-blue group-hover:text-academy-blue-dark mb-4 text-xl font-arabic tracking-wide transition-colors duration-300">
                            {req.title}
                          </h4>
                          <p className="text-academy-dark-gray leading-relaxed font-semibold text-lg font-arabic">
                            {req.description}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  {generalRequirements.map((req, index) => (
                    ...
                    >
                      ...
                      <p className="text-academy-blue group-hover:text-academy-gold font-bold text-xl font-arabic tracking-wide transition-colors duration-300 leading-relaxed">
                        {req}
                      </p>
                    </div>
                  ))}
      ...
      <section className="py-20 bg-academy-gray">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-academy-blue mb-4">
              نموذج التسجيل
            </h2>
            <p className="text-xl text-academy-dark-gray max-w-3xl mx-auto">
              املأ النموذج التالي للتقديم والانضمام إلى برامجنا التعليمية
              المتميزة
            </p>
          </div>
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-8 text-center">
          <div className="max-w-5xl mx-auto text-white">
            ...
            <p className="text-xl md:text-2xl text-academy-gold-light font-medium max-w-4xl mx-auto leading-relaxed mb-12">
              انضم إلى آلاف الطلاب الذين حققوا أهدافهم المهنية من خلال برامجنا
              المتميزة
            </p>
