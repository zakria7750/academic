  ...
  return (
    <>
        ...
        <CardHeader className="relative overflow-hidden">
          ...
          <div className="relative z-10 text-center py-8">
            ...
            <CardTitle className="text-3xl lg:text-4xl font-bold text-white mb-4 tracking-tight">
              نموذج الانضمام لشبكة المعلمين
            </CardTitle>
            <p className="text-academy-gold-light text-lg font-medium max-w-2xl mx-auto">
              انضم إلى مجتمع النخبة من المعلمين في أكاديمية المعرفة الدولية
            </p>
          </div>
        </CardHeader>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <Label
                    htmlFor="name"
                    className="text-academy-blue font-semibold text-lg flex items-center gap-2"
                  >
                    <User size={16} />
                    الاسم الكامل *
                  </Label>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <Textarea
                  ...
                  placeholder="شارك سيرتك وكيف ساهمت الأكاديمية في تطوير مسيرتك المهنية... اذكر التحديات التي واجهتها، الإنجازات التي حققتها، والتأثير الإيجابي للتعليم في الأكاديمية على مستقبلك المهني."
                />
                <p className="text-academy-dark-gray text-sm">شارك سيرتك </p>
              </div>
            </div>
      ...
      <Dialog
        ...
        onOpenChange={(open) =>
          setMessage((prev) => (prev ? { ...prev, open } : null))
        }
      >
